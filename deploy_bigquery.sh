...
gcloud run deploy $SERVICE_NAME \
    ...
    --set-env-vars="ENVIRONMENT=production,PROJECT_ID=$PROJECT_ID,PORT=8000,ALGORITHM=HS256,ACCESS_TOKEN_EXPIRE_MINUTES=30,BIGQUERY_DATASET=$DATASET_NAME,BIGQUERY_LOCATION=US,BACKEND_URL=https://sara-api-update-1024279616298.us-east1.run.app,FRONTEND_URL=https://sara-frontend-1024279616298.us-east1.run.app"
